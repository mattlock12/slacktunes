...
PSQL_USERNAME = os.environ.get('PG_SLACKTTUNES_USER', None) 'slacktuner'
PSQL_PASSWORD = os.environ.get('PG_SLACKTUNES_PASSWORD', None) 'slacktuner'
PSQL_SERVER = os.environ.get('PG_SLACKTUENS_SERVER', None) 'db'
PSQL_PORT = os.environ.get('PG_SLACKTUNES_PORT', None) '5432'
PSQL_DBNAME = os.environ.get('PG_SLACKTUNES_DBNAME', None) 'slacktunes_dev'
